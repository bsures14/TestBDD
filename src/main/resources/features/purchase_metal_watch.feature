...
Feature: Successfully Purchasing a Metal Watch
  ...
  Scenario: Successfully purchasing a metal watch
    ...
    And the user should see "Subtotal" as "$184.00" in table
    And the user should see "Order Total" as "$184.00" in table
    And the user should see "Didi Sport Watch"
    And the user should see the Proceed to Checkout Button
    ...
    And the user should see Order Summary
    And the user should see "Cart Subtotal" as "$184.00" in table
    And the user should see "Shipping" as "$10.00" in table
    And the user should see "Order Total" as "$194.00" in table
